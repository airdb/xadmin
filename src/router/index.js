...
export const constantRoutes = [{
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                path: 'signboard',
                component: () =>
                    import ('@/views/teamwork/signboard/SignBoard.vue'),
                name: 'SignBoard-demo',
    ...
    },
    {
        path: '/relationship',
        component: Layout,
        meta: { title: 'Relationship', icon: 'documentation' },
        alwaysShow: true,
        children: [{
            path: 'd3',
            component: () =>
            ...
            name: 'D3',
            meta: { title: '流量图', icon: 'documentation' }
        }]
    },
    {
        path: '/external-link',
        component: Layout,
        meta: { title: '文档连接', icon: 'guide' },
        children: [{
                path: 'https://github.com/airdb/xadmin',
                meta: { title: '管理后台', icon: 'link' }
            },
            {
                path: 'https://github.com/airdb/mgmt',
                meta: { title: '技术管理', icon: 'link' }
            },
            {
                path: 'https://airdb.net/zh/dev/',
                meta: { title: '环境管理', icon: 'link' }
            }
        ]
    }
    /*
